...
X_train = np.load(r'bool_datasets/'+dataset+'/X_train.npy')
Y_train = np.load(r'bool_datasets/'+dataset+'/Y_train.npy')
X_test = np.load(r'bool_datasets/'+dataset+'/X_test.npy')
Y_test = np.load(r'bool_datasets/'+dataset+'/Y_test.npy')
